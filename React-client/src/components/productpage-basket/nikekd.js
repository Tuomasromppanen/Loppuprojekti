...
const Nikekd = (props) => {
    ...
    const [NikeKD, setNikeKD] = useState(null);
        ...
        <div id="product">
            ...
            <div className="container product">
                <div className="row">
                        ...
                        <img className="d-block w-100" src={require('../../Kuvat/Tuotekuvat/Paivitetyt_Tuotekuvat/Nike_KD/Nike_KD_1.png')} alt=""/>              
                        </div>

                        <div className="d-sm-none carousel-item col-xs-12">
                        <img className="d-block w-100" src={require('../../Kuvat/Tuotekuvat/Paivitetyt_Tuotekuvat/Nike_KD/Nike_KD_2.png')} alt=""/>
                        </div>

                        <div className="d-sm-none carousel-item col-xs-12">
                        <img className="d-block w-100" src={require('../../Kuvat/Tuotekuvat/Paivitetyt_Tuotekuvat/Nike_KD/Nike_KD_3.jpg')} alt=""/>
                        </div>
                        ...
                        <div className="d-none d-sm-block col-sm-4 col-md-4 col-xl-4">
                        <img src={require('../../Kuvat/Tuotekuvat/Paivitetyt_Tuotekuvat/Nike_KD/Nike_KD_2.png')} alt=""/>
                        </div>

                        <div className="d-none d-sm-block col-sm-4 col-md-4 col-xl-4">
                        <img src={require('../../Kuvat/Tuotekuvat/Paivitetyt_Tuotekuvat/Nike_KD/Nike_KD_3.jpg')} alt=""/>
                        </div>
